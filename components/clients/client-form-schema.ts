  ...
  return [
    {
      ...
      form: [
        ...
        },
        {
          ...
          latitudeName: "adr_latitude",
          longitudeName: "adr_longitude",
          latitudeLabel: { labelText: "client.latitude.label" },
          longitudeLabel: { labelText: "client.longitude.label" },
          latitudePlaceholder: "client.latitude.placeholder",
          longitudePlaceholder: "client.longitude.placeholder",
          getLocationLabel: "client.get_current_location",
          getLocationSuccess: "client.get_location_success",
          getLocationError: "client.get_location_error",
