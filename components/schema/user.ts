...
export const UserSchema = z.object({
    name: z.string().min(1, { message: i18n.t("name_required") }),
    username: z.string().min(1, { message: i18n.t("username_required") }),
    email: z.string().min(1, { message: i18n.t("email_required") }),
    // company: z.object({
    //     name: z.string(),
    //     domain: z.string(),
    //     id: z.number(),
