...
- Name: flows\zones-crud.spec.ts >> Zones end-to-end CRUD flow >> shows validation error when submitting form without a name
- Location: tests\e2e\flows\zones-crud.spec.ts:12:7
